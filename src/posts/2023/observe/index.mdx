...
<Sections>
  ...
  <Section hash={SectionHash.Assumption1} deps={[SectionHash.Observation1]}>
    <SectionHeader>
    ...
    <SectionBody>
      ...
      - The Creator might operate with some other concepts or features that we, as human beings, can't grasp (**TODO: link to 2D vs 3D world** <Reference hash={SectionHash.Observation1} />)
    </SectionBody>
  </Section>
</Sections>
