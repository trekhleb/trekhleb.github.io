...
<Sections>
  <Section hash={SectionHash.Observation1}>
    <SectionHeader>
  ...
  <Section hash={SectionHash.Observation2}>
    <SectionHeader>
      We are like a **fetus** in mother's belly trying to think about **life after birth**
    </SectionHeader>
    <SectionBody>
      ...
      - Relates to the <Reference hash={SectionHash.Observation1} />
    </SectionBody>
  </Section>
