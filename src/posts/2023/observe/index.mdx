...
<Sections>
  <Section hash={SectionHash.Assumption1} siblings={[SectionHash.Assumption2]}>
    <SectionHeader>
  ...
  <Section hash={SectionHash.Assumption2} siblings={[SectionHash.Assumption1]}>
    <SectionHeader>
  ...
  <Section hash={SectionHash.Observation4}>
    <SectionHeader>
  ...
  <Section
    hash={SectionHash.Assumption3}
    deps={[
      SectionHash.Assumption1,
      SectionHash.Assumption2,
      SectionHash.Observation3,
      SectionHash.Observation4,
    ]}
  >
    <SectionHeader>
  ...
  <Section hash={SectionHash.Assumption4} deps={[SectionHash.Observation5]}>
    <SectionHeader>
    ...
    <SectionBody>
      ...
      - The Creator might operate with some other concepts or features that we, as human beings, can't grasp. See the <Reference hash={SectionHash.Assumption1} />
    </SectionBody>
  </Section>
</Sections>
