  ...
  <Section hash={SectionHash.Observation4} siblings={[SectionHash.Observation3]}>
    ...
    <SectionBody>
      ...
      - The following remain unanswered:
        - What is the origin of the lows of the Universe that singularity was following
          - How were the environmental constraints created
        ...
        - When/how the concept of time was introduced
