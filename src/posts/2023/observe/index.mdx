...
<Sections>
  <Section hash={SectionHash.Observation1}>
    ...
    <SectionBody>
      - We can continue asking the "What was before" or "What caused it" questions until we stuck
        - We are normally stuck at the <Link href="https://en.wikipedia.org/wiki/Big_Bang">Big Bang</Link> or the <Link href="https://en.wikipedia.org/wiki/Inflation_(cosmology)">Cosmic Inflation</Link> level
      - Example
  ...
  <Section hash={SectionHash.Observation2} siblings={[SectionHash.Observation3]}>
    <SectionHeader>
  ...
  <Section hash={SectionHash.Observation3} siblings={[SectionHash.Observation2]}>
    <SectionHeader>
  ...
  <Section hash={SectionHash.Assumption1} deps={[SectionHash.Observation4]}>
    <SectionHeader>
    ...
    <SectionBody>
      ...
      - The Creator might operate with some other concepts or features that we, as human beings, can't grasp. See the <Reference hash={SectionHash.Observation2} />
    </SectionBody>
  </Section>
</Sections>
