...
The genetic algorithm for this project is implemented in TypeScript. The full genetic source code will be shown in this article. You may also find the final code examples in the [Evolution Simulator repository](https://github.com/trekhleb/self-parking-car-evolution).
...
1. **Engine** - allows to move back and forth
2. **Steering wheel rotator** - allows to turn left and right while moving
