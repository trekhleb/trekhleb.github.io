...
> ☝🏻 The main conclusion from the "Eyes", "Muscles" and "Brain" sections above should be this: the coefficients `[e0, e1, ..., e8]` and `[w0, w1, ..., w8]` define the behavior of the car. In the following section these `18` numbers will be stitched together and will form unique car's Genome (or car's DNA).
