...
const snapshot: Snapshots = {
  ...
  'mui-org/material-ui': {
    id: 'mui-org/material-ui',
    description: 'MUI (formerly Material-UI) is the React UI library you always wanted. Follow your own design system, or start with Material Design.',
    kStars: 72.8,
  },
  'goldbergyoni/nodebestpractices': {
    id: 'goldbergyoni/nodebestpractices',
    description: 'The Node.js best practices list (October 2021)',
    kStars: 72,
  },
  ...
  'ryanmcdermott/clean-code-javascript': {
    id: 'ryanmcdermott/clean-code-javascript',
