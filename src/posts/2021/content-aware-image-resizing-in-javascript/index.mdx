...
The good part about this approach is that it is fast, and it has a time complexity of `O(n)`. In this case, the cost of the speed is the low quality of resizing.
