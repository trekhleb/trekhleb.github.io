...
summary: "JavaScript implementation of so-called Seam Carving algorithm for the content-aware image resizing. Dynamic programming approach is applied to optimize the resizing time."
