...
Once we found the lowest energy seam, we need to remove the pixels that form it from the image. All the pixels to the right of the seam need to be shifted by `1px` to the left.

![Deleting the seam](assets/60-deleting.png)
