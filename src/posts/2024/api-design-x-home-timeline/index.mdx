...
>
> You may find all types in [types/x.ts](https://github.com/trekhleb/trekhleb.github.io/blob/master/src/posts/2024/api-design-x-home-timeline/types/x.ts) file or at the bottom of this article in the "Appendix: All types at one place" section.
...
## Appendix: All types at one place
