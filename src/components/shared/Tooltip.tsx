...
const Tooltip = (props: TooltipProps): React.ReactElement => {
  ...
  const popoverCommonClassName = 'absolute flex z-10 transition-all duration-300 w-screen sm:w-64 left-0 sm:left-auto sm:-translate-x-1/2';
  ...
  return (
    ...
    >
      ...
      <div role="tooltip" className={popoverClassName}>
        <div className="px-3 py-2 mx-2 text-sm text-white bg-black rounded-lg drop-shadow-md w-full">
          {content}
        </div>
      </div>
    </div>
